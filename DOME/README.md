...
| 5  | PricePlan         | relatedParty + forbiddenCharacteristics             |  ProductOfferingPrice (TMF620) | - _relatedParty_: to secure and restrict transmission between involved parties. <br> - _forbiddenCharacteristics_:  to define a list of not allowed characteristics for the pricePlan and its priceComponents |.                      |
